...
*/
router.post("/eforce-gallery/photo-gallery/download-whole-gallery", async function (request, response) {
...
*/
router.get("/eforce-gallery/download/photos", async function (request, response) {
...
*/
router.post("/eforce-gallery/download/generate-token-for-download", async function (request, response) {
